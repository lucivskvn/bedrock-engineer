export const en = {
  ...
  organization: {
    ...
    dropdownMenuLabel: 'Organization menu (current: {{name}})',
    dropdownTriggerAria: 'Open organization selection menu',
    selectAllAgents: 'Select All Agents',
    selectContributors: 'Select Contributors',
    selectSpecificOrganization: 'Select organization {{name}}',

export const ja = {
  ...
  organization: {
    ...
    dropdownMenuLabel: '組織メニュー（現在: {{name}}）',
    dropdownTriggerAria: '組織選択メニューを開く',
    selectAllAgents: 'すべてのエージェントを選択',
    selectContributors: 'コントリビューターを選択',
    selectSpecificOrganization: '{{name}} を選択',

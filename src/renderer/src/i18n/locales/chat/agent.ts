...
- Guidance based on best practices`,
    ...
    datePlaceholder: 'Today e.g., YYYY-MM-DD',
    ...
    delete: 'Delete',
    more: 'More options',
    'agent.actionMenuLabel': 'Agent actions',
    'agent.actionMenuTriggerAria': 'Open actions menu for {{name}}',
    'agent.unnamedAgent': 'this agent',
...
- ベストプラクティスに基づいたガイダンス`,
    ...
    datePlaceholder: '本日日付 （例：YYYY-MM-DD）',
    ...
    delete: '削除する',
    more: 'その他のオプション',
    'agent.actionMenuLabel': '操作メニュー',
    'agent.actionMenuTriggerAria': '{{name}} の操作メニューを開く',
    'agent.unnamedAgent': 'このエージェント',
